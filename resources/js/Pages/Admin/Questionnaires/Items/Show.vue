<template>
    <div>
        ...
        <div class="wrap section">
            <div class="title-section">
                <div class="title">Uređivanje čestice</div>
            </div>
            <div class="section">
                <p>Uređivanje čestica je moguće jedino ako upitnik za odabranu česticu nije zaključan.</p>
            </div>
        ...
        <div class="wrap">
            <div class="title-section">
                <div class="subtitle">Brisanje čestice</div>
            </div>
            <div class="section">
                <p>Želite li obrisati česticu? Brisanje je moguće jedino ako upitnik za odabranu česticu nije zaključan.</p>
            </div>
            <button type="button" class="button red ghost" @click="deleteItem">
                <svg style="width:20px;height:20px" viewBox="0 0 24 24">
    ...
    data() {
        return {
            formData:  this.$inertia.form({
                ...
                ascending_order: !!this.item.ascending_order,
            })
        }
    },
    methods: {
        updateItem() {
            this.formData.post(`/admin/questionnaires/${this.questionnaire.id}/items/${this.item.id}/update`);
        },
        deleteItem() {
            this.formData.post(`/admin/questionnaires/${this.questionnaire.id}/items/${this.item.id}/destroy`);
        }
    }
}
</script>
